...
public class NoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewModelProvider ViewModelProvider = new ViewModelProvider(getViewModelStore(), androidx.lifecycle.ViewModelProvider.AndroidViewModelFactory.getInstance(getApplication()));
